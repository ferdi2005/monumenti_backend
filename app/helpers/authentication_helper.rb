module AuthenticationHelper
    ...
    $test_oauth_consumer = OAuth::Consumer.new(ENV["TEST_CONSUMER_KEY"], ENV["TEST_CONSUMER_SECRET"], :site => "https://ferdi.host", :request_token_path => "/w/index.php?title=Special:OAuth/initiate", :authorize_path => "/wiki/Special:OAuth/authorize", :access_token_path => "/wiki/Special:OAuth/token",)
